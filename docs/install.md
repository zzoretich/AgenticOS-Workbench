...
1. `AOS_HOST` in the environment — set by every Codex hook entry and by the Codex MCP registration (the Claude Code plugin sets nothing and is the default);
