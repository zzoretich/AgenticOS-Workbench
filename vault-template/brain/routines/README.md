...
schedule: "30 7 * * 1-5"
enabled: true
model: haiku            # prompt: default claude.model · duty: that duty's Claude model (default persona.model, see below)
effort: low             # prompt, duty; low | medium | high
