...
export interface VaultConfig {
  ...
  updates: { check: boolean; intervalHours: number };
  cost: { enabled: boolean; monthlyBudget: number | null };
  persona: { enabled: boolean; perDutyUsd: number; perDayUsd: number; watchdog: { graceMinutes: number; notify: boolean }; tick: { flagAgeDays: number } };
...
export const VAULT_CONFIG_DEFAULTS: VaultConfig = {
  ...
  persona: { enabled: true, perDutyUsd: 2.0, perDayUsd: 6.0, watchdog: { graceMinutes: 45, notify: true }, tick: { flagAgeDays: 7 } },
