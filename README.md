...
plugin             the Claude Code plugin: hooks.json, .mcp.json, bin/aos, 20 commands, 9 skills (also the source of codex-plugin)
codex-plugin       the Codex plugin, generated from plugin/ by npm run build:codex-plugin: hooks.json, .mcp.json, bin/aos, 27 skills
